...
getPostsResp :: Monad m => Handle m -> (Response -> m ResponseReceived) -> Query -> m ResponseReceived
...
createPostResp :: Monad m => Handle m -> (Response -> m ResponseReceived) -> Query -> m ResponseReceived
...
removePostResp :: Monad m => Handle m -> (Response -> m ResponseReceived) -> Query -> m ResponseReceived
...
setPostMainPhotoResp :: Monad m => Handle m -> (Response -> m ResponseReceived) -> Query -> m ResponseReceived
...
setPostAddPhotoResp :: Monad m => Handle m -> (Response -> m ResponseReceived) -> Query -> m ResponseReceived
