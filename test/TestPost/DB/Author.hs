...
spec_getUserIdByAuthorId =
  describe "Testing getUserIdByAuthorId" $ do
    ...
    it "Should fail on array of many elements" $ do
      let authorId = 100 :: PSO.UserId
          userId1 = 22 :: PSO.AuthorId
          userId2 = 30 :: PSO.AuthorId
          sqlAuthorA = [
            [toSql userId1],
            [toSql userId2]]
          dbqh' = H.dbqh {
...
spec_getAuthorRecord =
  describe "Testing getAuthorRecord" $ do
    it "Should fail on array of many elements" $ do
      let authorId = 101 :: PSO.AuthorId
          desc1 = "The best!" :: PSO.Description
          desc2 = "New" :: PSO.Description
          sqlAuthorA = [
